...
/**
 * Utility class for JSON serialization and deserialization using Jackson. This class follows the
 * <strong>Single Responsibility Principle</strong> by focusing solely on JSON conversion.
 * Moreover,
 * by relying on the abstract marker interface {@code Serializable}, it observes the
 * <strong>Dependency Inversion Principle</strong>. Note: The parameter type {@code Serializable}
 * is
